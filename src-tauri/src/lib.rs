...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::items::list_stock_movements,
            commands::items::list_item_price_history,
            ...
            commands::config::get_item_code_pad_length,
            commands::config::set_item_code_pad_length,
            ...
            commands::config::get_printer_name,
            commands::config::set_printer_name,
            commands::receipts::list_printers,
            ...
            commands::receipts::get_receipts_folder,
            commands::receipts::set_receipts_folder,
            commands::receipts::clear_receipts_folder,
            ...
            commands::clients::list_credit_sales,
