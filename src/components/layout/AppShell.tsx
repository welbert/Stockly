...
const NAV_ITEMS: { item: NavItem; adminOnly: boolean; group: (isAdmin: boolean) => string }[] = [
  ...
  { item: { kind: "link", to: "/clientes", label: "Clientes", icon: "💳" }, adminOnly: false, group: () => "Operação" },
...
const PAGE_META: Record<string, { title: string; subtitle: string }> = {
  ...
  "/clientes": { title: "Clientes", subtitle: "Cadastro de clientes, saldo em aberto e histórico de compras" },
